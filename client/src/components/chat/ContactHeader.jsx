  ...
  return (
    <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                <span onClick={(e)=>{setMenuToggle(!menuToggle)}}>
                ...
                {menuToggle && (
                    <div className="absolute left-[220px] z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                    <div className="py-1" role="none">
                      <li className="hover:bg-gray-300 text-gray-700 block px-4 py-2 text-sm cursor-pointer" id="cmenu-item-0">New Group</li>
                      <li className="hover:bg-gray-300 text-gray-700 block px-4 py-2 text-sm cursor-pointer" id="cmenu-item-1">Select Chat</li>

                      <li className="hover:bg-gray-300 text-gray-700 block px-4 py-2 text-sm cursor-pointer" id="cmenu-item-2">Settings</li>
                      <Logout />
                    </div>
                  </div>
                )}
